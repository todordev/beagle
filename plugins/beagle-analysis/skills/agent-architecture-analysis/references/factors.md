# 12-Factor Agents: Per-Factor Analysis Framework

> Reference: [12-Factor Agents](https://github.com/humanlayer/12-factor-agents)

This file holds the full per-factor rubric for the **agent-architecture-analysis** skill: principle, search patterns, file patterns, compliance criteria, and anti-patterns for each of the 13 factors. The skill's `SKILL.md` indexes these; read the relevant factor sections here when performing the deep dive.
